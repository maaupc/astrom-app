...
const UsValues = () => {
  return (
    <div className="title-beneficio">
      <h1 className="item beneficios">Beneficios</h1>
      <hr className="elementor_divider-benefits"/>
      <div className="container-valores">
        <div className="item seguridad">
          <img
            ...
            alt="seguridad"
          />
          <span className="title-beneficio">Seguridad</span>
        ...
        <div className="item confianza">
          ...
          <span className="title-beneficio">Confianza</span>
          <p className="parrafo-beneficio">
        ...
        <div className="item rapidez">
          <img
            ...
            alt="rapidez"
          />
          <span className="title-beneficio">Rápida implementación</span>
        ...
        <div className="item disponibilidad">
          <img
            ...
            alt="disponibilidad"
          />
          <span className="title-beneficio">Alta disponibilidad</span>
          <p className="parrafo-beneficio">
        ...
        <div className="item alertas">
          ...
          <span className="title-beneficio">Generación de alertas</span>
          <p className="parrafo-beneficio">
        ...
        <div className="item escalabilidad">
          <img
            ...
            alt="escalabilidad"
          />
          <span className="title-beneficio">Escalabilidad</span>
          <p className="parrafo-beneficio">
